...
| `recommendedCapabilities` | array | Stage-aware tool/workflow/policy hints returned by `smart-route`; core-required tools are expected from the default bundle and workflow/policy hints need no installation |
