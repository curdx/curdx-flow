...
parallel decomposition, `frontend-design`/`ui-ux-pro-max` for visible UI work, and Chrome
...
2. Suggest: "Run /curdx-flow:tasks to generate task list"
3. Do NOT continue execution
4. Do NOT output ALL_TASKS_COMPLETE
...
2. Suggest: "Run /curdx-flow:new <spec-name> to create a new spec"
3. Do NOT continue execution
4. Do NOT output ALL_TASKS_COMPLETE
