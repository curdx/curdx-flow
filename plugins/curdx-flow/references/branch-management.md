...
1. Get current branch name
   ...
   |   |   - Suggest: "Run /curdx-flow:research to start the research phase."
   ...
   |   |     "Then run /curdx-flow:research to begin."
...
Then run /curdx-flow:research to begin the research phase.
```
