...
**Last updated:** 2026-05-07T13:25:06Z
...
| spec-cost-time-token-analytics | ./specs | design | awaiting approval |
...
**Commands:**
- `/curdx-flow:status` - Show detailed status
- `/curdx-flow:switch <name>` - Switch active spec
- `/curdx-flow:start <name>` - Create or resume spec
